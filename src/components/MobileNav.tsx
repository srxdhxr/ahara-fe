...
export default function MobileNav() {
  ...
  return (
    <nav
      className="fixed left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-md bg-white/40 backdrop-blur-xl rounded-[20px] clay-shadow-strong border border-white/60 px-2 py-2 z-50"
